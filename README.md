...
* #### [V6](https://github.com/huaPeiLiang/fast-cloud/tree/v6)：Nacos、OpenFeign、Ribbon、MyBatis-Plus、Redis、Mysql、JWT、gateway
  * **前提条件：** 有可使用的Mysql服务、redis服务、Nacos服务。
  * **提供：** 让分布式中的异常处理变得和单机项目一样，无需考虑异常透传、统一包装、触发回滚问题。
